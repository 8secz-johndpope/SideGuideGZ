...
struct DesignConstants {
    ...
    static let THEME_SECONDARY = UIColor(red: 0.36, green: 0.54, blue: 0.76, alpha: 1.00)
    static let THEME_BACKGROUND = UIColor(red:0.89, green:0.89, blue:0.89, alpha:1.00)
